...
public class GameController implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
    	...
    	renderer.addCharacterEntity(new Player(600, 500, 100, 100,
    	...
    	renderer.addCharacterEntity(new AIEntity(1300, 500, 100, 100,
    	...
    	renderer.addCharacterEntity(new AIEntity(1400, 500, 100, 100,
    			new Image(getClass().getResourceAsStream("/resources/LeftIdle2.png")),
    			new Image(getClass().getResourceAsStream("/resources/RightIdle2.png"))));
    	
    	renderer.addStaticRectEntity(new StaticRectEntity(0, 880, 1600, 20, new Color(0, 0, 0, 1.0)));
    ...
    private void updateAIMovement(AIEntity entity, float frameDuration, List<CharacterEntity> characterList) {
    	...
    	if (entity.nearestEnemy.isDead) {
    		...
    		else if (entity.xpos > 1200) {
    			entity.moveLeft = true;
    		}
    	}
    	else {
    		if (entity.vectorToNearestEnemy.x < -50) {
    			entity.moveLeft = true;
    			entity.isLookingRight = false;
    		}
    		else if (entity.vectorToNearestEnemy.x > 50) {
    			entity.moveRight = true;
    		...
    		if (entity.distanceSquaredToNearestEnemy < 500) {
    ...
    private void updateCharacterMovement(CharacterEntity entity, float frameDuration) {
    	if(entity.isDead) {
    		...
    		if (entity.deathAnimationTimer > 2 & entity.lives > 1) {
    			entity.lives -= 1;
    	...
    	if (entity.xpos < -100 | entity.xpos > 1600) {
    		entity.isDead = true;
    	}
